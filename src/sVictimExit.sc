...
(instance sGlob1 of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(if
				(< (gSQ5 detailLevel:) ((ScriptID 500 3) detailLevel:))
...
(instance sGlob2 of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(if
				(< (gSQ5 detailLevel:) ((ScriptID 500 4) detailLevel:))
...
(instance sGuys of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(if
				(< (gSQ5 detailLevel:) (guy1Mouth detailLevel:))
					(guy1Mouth stopUpd:)
					(-- state)
				else
...
(instance theNukem of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(1
				(gTestMessager say: 10 theVerb 0 0)
			)
			(else 
	...
	(method (doVerb theVerb)
		(switch theVerb
			(3
				(switch global167
					(0
						(global2 setScript: (ScriptID 500 5))
					)
					(1
						(global2 setScript: (ScriptID 500 5))
					)
					(2
						(global2 setScript: (ScriptID 500 11))
					)
				)
			)
			(4
			...
			(1
				(gTestMessager say: 22 theVerb 0 0 500)
			)
			(else 
				(super doVerb: theVerb &rest)
			)
...
(instance theQuirk of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(1
				(if (proc0_1 53)
					(gTestMessager say: 15 theVerb 0 0 500)
				)
			)
			(else 
				(super doVerb: theVerb &rest)
...
(instance theAlien of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(1
				(if (proc0_1 53) (gTestMessager say: 2 theVerb 0 0 500))
			)
			(else 
				(super doVerb: theVerb &rest)
			)
...
(instance thePatrons1 of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(1
				(if (not (proc0_1 54))
					(gTestMessager say: 11 theVerb 0 0 500)
				)
			)
			(else 
				(super doVerb: theVerb &rest)
...
(instance thePatrons2 of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(1
				(if (not (proc0_1 54))
					(gTestMessager say: 12 theVerb 0 0 500)
				)
			)
			(else 
				(super doVerb: theVerb &rest)
...
(instance theTeleporter of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(3
				(if (proc0_1 62)
					(global2 setScript: (ScriptID 500 8))
				else
					(global2 setScript: (ScriptID 500 7))
				)
			)
			(4
				(if (proc0_1 62)
...
(instance theTable of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(3
				(if (and (not (proc0_1 62)) (not (proc0_1 54)))
					(global2 setScript: (ScriptID 500 9))
				)
				(if (and (proc0_1 62) (not (proc0_1 54)))
					(global2 newRoom: 520)
				)
			)
			(4
	...
	(method (doVerb theVerb)
		(switch theVerb
			(3
				(switch global167
					(1
						(global2 setScript: (ScriptID 500 12))
					)
					(2
						(global2 setScript: (ScriptID 500 12))
					)
