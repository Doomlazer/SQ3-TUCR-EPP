		...
		(switch (= state newState)
			...
			(4
				...
				(switch register
					...
					(1
						(cond 
							((< global170 2) (gTestMessager say: 6 1 0 4 self 202))
							(
							(and (< (eureka puke?) 1) (not (proc0_1 86))) (= next sPushOrange) (= cycles 1))
							(else (= cycles 1))
						)
					)
					(2
...
(instance sPushGreen of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(if (proc0_1 60)
					(gTestMessager say: 6 0 8 1 self)
				else
					(gTestMessager say: 6 0 8 2 self)
				)
			)
			(2
...
(instance sPushOrange of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(gTestMessager say: 40 0 0 1 self)
			)
			(2
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(monitor3 setCel: 1)
				(monitor1 setCel: 1)
				(if (gOldCast contains: monitor2) (monitor2 setCel: 1))
				(= ticks 20)
			)
			(2
				(monitor1 setCel: 0)
				(if (gOldCast contains: monitor2) (monitor2 setCel: 0))
				(monitor3 setCel: 0)
				(= state (- state 2))
				(= ticks 45)
			)
	...
	(method (init)
		(if
			(or
				(>= (eureka puke?) 4)
				(proc0_1 84)
				(== (global2 script?) (ScriptID 208 0))
			)
			(self loop: 0 cel: 0 setScript: sBlink noun: 36)
			(if
			(and (not (proc0_1 84)) (!= (gSq5Music2 number?) 105))
...
(instance monitor2 of Prop
	...
	(method (init)
		(cond 
			((or (>= (eureka puke?) 4) (proc0_1 61)) (self loop: 2 cel: 0 noun: 37) (super init: &rest))
			((not (proc0_1 84)) (self loop: 6 cel: 1 noun: 40) (super init: &rest))
		)
	)
)
