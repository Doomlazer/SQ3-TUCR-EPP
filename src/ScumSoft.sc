		...
		(switch (event type?)
			(saidEvent
				(cond 
					...
					((Said 'converse,look/man,folk,bystander,programmer,accountant')
						(Print 702 3)
					)
					...
					((Said 'sit,explore,get,beat,beat,get,feel/chart,woman,calendar,board,chair,man,desk,paper,partition')
						(Print 702 6)
					)
				)
			)
